...
> 文档性质：官方文档索引与创建形态梳理
>
> 仓库基线：`74dfe05132aaf8f0600c892b5f1388a20c82b13b`
...
- [Managed Agents Tools](https://platform.claude.com/docs/en/managed-agents/tools)：内置工具、custom tool 以及 MCP Connector 的配置方式。

自定义 Tool 是 Agent 配置中的契约，由调用方应用实际执行；MCP Tool 则由连接的 MCP Server 提供。
