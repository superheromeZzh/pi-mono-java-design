...
[PlantUML 源码](./diagram.puml#L311)

一个注册 Tool 同时实现独立的 metadata trait 和 runtime trait。[metadata 源码](https://github.com/xai-org/grok-build/blob/8adf9013a0929e5c7f1d4e849492d2387837a28d/crates/codegen/xai-grok-tools/src/types/tool_metadata.rs#L1-L10)、[runtime 源码](https://github.com/xai-org/grok-build/blob/8adf9013a0929e5c7f1d4e849492d2387837a28d/crates/common/xai-tool-runtime/src/tool.rs#L32-L110)

#### 10.2.3 Anthropic API / Managed Agents

![Anthropic client tool contract](./anthropic_client_tool_contract.svg)

[PlantUML 源码](./diagram.puml#L339)
...
[PlantUML 源码](./diagram.puml#L526)

Claude Code 配置客户端连接，MCP Server 拥有 Tool 描述和业务执行。[官方 MCP 文档](https://code.claude.com/docs/en/mcp)

#### 10.4.2 Kiro CLI

![Kiro CLI MCP tool model](./kiro_mcp_tool_model.svg)

[PlantUML 源码](./diagram.puml#L567)
