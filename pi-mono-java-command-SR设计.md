...
[查看 PlantUML 源码](./diagrams/command/diagram.puml#L221)
...
[查看 PlantUML 源码](./diagrams/command/diagram.puml#L257)
...
[查看 PlantUML 源码](./diagrams/command/diagram.puml#L294)
...
[查看 PlantUML 源码](./diagrams/command/diagram.puml#L336)
...
因此该枚举属于 Java 架构改造：TUI 与 App 共享 Dispatcher 后可能同时发起命令，需要由 `CommandExecutionGate` 统一处理并发。它与 `mode` 分开，是因为同为 `IMMEDIATE` 的 `/copy` 和 `/model` 具有不同并发要求：前者可以安全共享执行，后者修改当前模型，需要独占执行。

### 9.5 pi 22 个 Built-in 的建议映射
...
[查看 PlantUML 源码](./diagrams/command/diagram.puml#L369) · [查看 pi `/model` 补全源码](https://github.com/badlogic/pi-mono/blob/bb959aae017eedc8edaa91d01d0475d483ea9371/packages/coding-agent/src/modes/interactive/interactive-mode.ts#L506-L533)
...
[查看 PlantUML 源码](./diagrams/command/diagram.puml#L399)
...
[查看 PlantUML 源码](./diagrams/command/diagram.puml#L431)
...
[查看 PlantUML 源码](./diagrams/command/diagram.puml#L459)
...
[查看 PlantUML 源码](./diagrams/command/diagram.puml#L485)
